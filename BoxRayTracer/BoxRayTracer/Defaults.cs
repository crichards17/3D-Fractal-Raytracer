...
namespace BoxRayTracer
{
    internal class Defaults
    {
        ...
        // Light defaults
        private static readonly AmbientLight globalAmbient1 = new AmbientLight(new Color(1.0,1.0,1.0), 0.5);
        ...
        private static readonly PointLight pointLight1 = new PointLight(new Color(0.2, 1.0, 1.0), 0.5, 0.5, new Vector(5, 5, 5));
